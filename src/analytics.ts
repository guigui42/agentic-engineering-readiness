...
const DEFAULT_HYDRO_APP_ID = 'aes-assessment'
const EVENT_TYPE = 'aes_assessment.interaction'
...
type InteractionAction = 'change' | 'copy' | 'reset'
...
const analyticsClient = createConfiguredAnalyticsClient(
  import.meta.env.VITE_HYDRO_APP_ID || DEFAULT_HYDRO_APP_ID,
)
